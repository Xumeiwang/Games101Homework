...
void rst::rasterizer::draw(pos_buf_id pos_buffer, ind_buf_id ind_buffer, col_buf_id col_buffer, Primitive type, bool isSSAA)
{
...
void rst::rasterizer::rasterize_triangle(const Triangle& t, bool isSSAA) {
    auto v = t.toVector4();
